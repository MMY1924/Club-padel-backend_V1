        ...
        if instance.estado == 'Finalizado' and estado_anterior != 'Finalizado':
            ...
            try:
                ...
                if not instance.equipo_ganador:
                    print(f"⚠️  Partido {instance.id} finalizado sin equipo ganador. Saltando...")
                    return
                ...
                if historial_existente.exists():
                    print(f"ℹ️  Partido {instance.id} ya tiene historial ({historial_existente.count()} registros). Saltando...")
                    return
